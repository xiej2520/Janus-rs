...
$mrsequential wc ../rsrc/pg*.txt || exit 1
...
(maybe_quiet $TIMEOUT $mrworker wc) &
(maybe_quiet $TIMEOUT $mrworker wc) &
(maybe_quiet $TIMEOUT $mrworker wc) &
...
maybe_quiet $TIMEOUT $mrworker mtiming &
maybe_quiet $TIMEOUT $mrworker mtiming
...
maybe_quiet $TIMEOUT $mrworker rtiming  &
maybe_quiet $TIMEOUT $mrworker rtiming
...
maybe_quiet $TIMEOUT $mrworker jobcount &
maybe_quiet $TIMEOUT $mrworker jobcount
maybe_quiet $TIMEOUT $mrworker jobcount &
maybe_quiet $TIMEOUT $mrworker jobcount
